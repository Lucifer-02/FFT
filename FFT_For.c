...
#define N 32                    // ATTENTION!!! Number of sample points, Nyquist Law
#define logN log2(N)              // logarit 2 of N                   
...
// reverse n early bits of indexs
...
void FFT(double *x, _Complex *X)   // Fast Fourier Transform signal
{
    ...
    // Have total (log2(N) - 1) step according Butterfly graph, at step = 1, number of point = 2*step
